<template>
    <div class="modal">
        <div class="modal-container">
            ...
            <div v-if="!success" class="modal-text">
                <div class="font-primary-bold modal-title">
                    Subscribe to our newsletter
                </div>
                <div class="modal-paragraph font-primary-light">
                    Subscribe to our newsletter and start getting free recipes every Saturday!
                </div>
                <div class="email-input">
                    <input type="email" class="font-primary-light" :class="{'no-email':noEmail}" v-model="email" name="query" placeholder="Enter your email here" />
                </div>
...
export default {
    setup() {
        ...
        function closeModal() {
            store.commit('recipes/showingModal', false);
        }

		const email = computed({
            get: () => store.getters['recipes/email'],
            set: (value) => store.commit('recipes/setEmail', value),
        });
